...
def fokker_planck(x_t, s_i, mu, i, seq):
    """
...
theta = "I think some constant"  # It's a constant.
...
def s_inference(seq, generations):
    ...
    for idx, site in enumerate(seq):
        ...
        for i, generation in enumerate(generations):
            ...
            fo_pl = fokker_planck(x_t=site, s_i=site_selection_coefficient, mu=mutation_rate, i=idx, seq=seq)
            c_xt_k = c_ij(x_t=fo_pl, i=idx, j=idx) # TODO: Is this being used correctly? Doubt...
